package com.tianfang.eventreporter;
...
public class MainActivity extends AppCompatActivity implements EventFragment.OnItemSelectListener {
    ...
    private EventsFragment mListFragment;
...
//        Fragment fragment_event = fragmentManager.findFragmentById(R.id.event_container);
//        Fragment fragment_comment = fragmentManager.findFragmentById(R.id.comment_container);
//        if(isChangingConfigurations()) {
//            if (fragment_event != null) {
//                fragmentManager.beginTransaction().remove(fragment_event).commit();
//            }
//            if (fragment_comment != null) {
//                fragmentManager.beginTransaction().remove(fragment_comment).commit();
//            }
//        }
